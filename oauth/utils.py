...
from oauth.compat import get_username
from oauth.compat import get_username_field
...
def jwt_response_payload_handler(token, user=None, request=None):
    ...
    return {
        'token': u'%s %s' % (api_settings.JWT_AUTH_HEADER_PREFIX, token, ),
        'account': UserSerializer(user, context=context).data
    }
